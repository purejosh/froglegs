...
public class GoldenTemperateFrogLegItem extends Item {
	public GoldenTemperateFrogLegItem() {
		super(new Item.Properties().stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(8).saturationMod(0.9f)
